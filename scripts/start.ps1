...
$json = & $py -c "import json; from local_study_app.process import start; print(json.dumps(start()))"
...
Write-Host $result.data.url
if (!$NoOpen) { Start-Process $result.data.url }
